...
\acrlong{JIT} compilation is a term which refers to any technique which
...
two compilers (e.g. as implemented in LuaJIT, \autoref{fig:two-tier-jit}):
...
\begin{enumerate}
		...
		in the generated bytecode, which gather statistics about program execution.
		...
		slower compilation speed, compared to the tier 1 compiler. Therefore, the
