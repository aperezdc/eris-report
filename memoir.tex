...
\newcommand\Tick{\inlinesymbol\checkmark\relax}

% Glossary/Acronyms
\usepackage[acronym]{glossaries}
\newacronym{ELF}{\textsc{Elf}}{Executable and Linkable Format}
\newacronym{DWARF}{\textsc{Dwarf}}{Debugging With Attributed Record Formats}
...
\def\Ldwarf*{\texttt{libdwarf}}
\def\Lelf*{\texttt{libelf}}
\def\Lffi*{\texttt{libffi}}
\def\Lreadline*{\texttt{libreadline}}
\def\ErisSo*{\texttt{eris.so}}
\def\GnuLinux*{\textsc{Gnu}/Linux}
\def\GnuMake*{\textsc{Gnu} Make}
\def\Eris*{\textsc{Eris}}
...
% \setmonofont[Scale=MatchLowercase]{CamingoCode}
\setmonofont[Scale=MatchUppercase]{CamingoCode}
